...
def load_and_process_data():
    ...
    # ============================================
    phyto = pd.read_csv('/Users/akurukunda01/Desktop/VS CODE projects/AK_web_dev/ISEF2025-26/nla_2017_phytoplankton_count-data.csv', encoding='latin1')
    ...
    # ============================================
    profile = pd.read_csv('/Users/akurukunda01/Desktop/VS CODE projects/AK_web_dev/ISEF2025-26/nla_2017_profile-data.csv', encoding='latin1')
    ...
    # ============================================
    chem = pd.read_csv('/Users/akurukunda01/Desktop/VS CODE projects/AK_web_dev/ISEF2025-26/nla_2017_water_chemistry_chla-data.csv', encoding='latin1')
    ...
    final_data.to_csv('cyano_prediction_data_with_turb.csv', index=False)
    print("\n✅ Saved to: cyano_prediction_data_with_turb.csv")
...
def train_model():
    ...
    """ 
    data = pd.read_csv('/Users/akurukunda01/Desktop/VS CODE projects/AK_web_dev/ISEF2025-26/cyano_prediction_data_with_turb.csv')
...
def explore_water_chemistry():
    ...
    chem = pd.read_csv('/Users/akurukunda01/Desktop/VS CODE projects/AK_web_dev/ISEF2025-26/nla_2017_water_chemistry_chla-data.csv', encoding='latin-1')
...
def load_and_process_data_classification(threshold=20):
    ...
    # SAVE DATA
    # ============================================
    filename = f'cyano_classification_data_threshold_{threshold}.csv'
...
def train_classification_model():
    ...
    data = pd.read_csv('/Users/akurukunda01/Desktop/VS CODE projects/AK_web_dev/ISEF2025-26/cyano_classification_data_threshold_20.csv')
